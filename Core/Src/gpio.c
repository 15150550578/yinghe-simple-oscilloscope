...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED_Green_Pin|Buzz_PWM_Pin|SW2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED_Green_Pin Buzz_PWM_Pin SW2_Pin */
  GPIO_InitStruct.Pin = LED_Green_Pin|Buzz_PWM_Pin|SW2_Pin;
